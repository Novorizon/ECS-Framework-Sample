#ifndef UNIVERSAL_LIGHTING_Optimize_INCLUDED
#define UNIVERSAL_LIGHTING_Optimize_INCLUDED
...
half DirectBRDFSpecular(BRDFData brdfData, half3 normalWS, half3 lightDirectionWS, half3 viewDirectionWS)
{
    ...
    half LoH2 = LoH * LoH;
    half specularTerm = brdfData.roughness2 * rcp((d * d) * max(0.1h, LoH2) * brdfData.normalizationTerm);
